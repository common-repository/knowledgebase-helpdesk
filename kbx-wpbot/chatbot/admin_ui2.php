                    ...
                    <div class="wpbot_addon_content">
                        ...
                        <div class="wpbot_addon_details">
                            ...
                            <?php if(function_exists('qcformbuilder_forms_load')){
                                ...
                                <?php if($cfb=='Free'): ?>
                                <a class="button button-secondary" href="https://www.quantumcloud.com/products/conversations-and-form-builder/" target="_blank" ><?php esc_html_e('Upgrade to Pro ', 'wpbot'); ?></a>
                                <?php endif; ?>
                                <?php
                            }else{
                                ?>
