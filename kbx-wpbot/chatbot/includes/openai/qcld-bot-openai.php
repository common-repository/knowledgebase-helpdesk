    ...
    final class qcld_wpopenai_addons
    {
        ...
        public function openai_settings_option_callback() {
            ...
            if (! wp_verify_nonce($nonce,'wp_chatbot')) {
                ...
                $openai_engines             = isset( $_POST['openai_engines'] )             ? sanitize_text_field($_POST['openai_engines']) : '';
                $qcld_openai_prompt         = isset( $_POST['qcld_openai_prompt'] )         ? sanitize_text_field($_POST['qcld_openai_prompt']) : '';
                $max_tokens                 = isset( $_POST['max_tokens'] )                 ? sanitize_text_field($_POST['max_tokens']) : '';
                $qcld_openai_suffix         = ( isset($_POST['qcld_openai_suffix']) && !empty($_POST['qcld_openai_suffix']))        ? sanitize_text_field($_POST['qcld_openai_suffix']) : '';
                ...
                $ai_enabled                 = isset( $_POST['ai_enabled'] )                 ? sanitize_text_field($_POST['ai_enabled']) : '';
                $suggestion_enabled         = isset( $_POST['is_page_suggestion_enabled'] ) ? sanitize_text_field($_POST['is_page_suggestion_enabled']) : '';
                $is_relevant_enabled        = isset( $_POST['is_relevant_enabled'] )        ? sanitize_text_field($_POST['is_relevant_enabled']) : '';
              
                $ai_only_mode               = isset( $_POST['ai_only_mode'] )               ? sanitize_text_field($_POST['ai_only_mode']) : '';
                ...
                $conversation_continuity    = isset( $_POST['conversation_continuity'] )    ? sanitize_text_field($_POST['conversation_continuity']) : '';
				
				/* Customized by Kadir on 05-12-2023 : To set empty value for API field */

                $disable_ss                 = isset( $_POST['conversation_continuity'] )    ? sanitize_text_field($_POST['disable_ss']) : '';
