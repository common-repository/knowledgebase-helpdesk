...
class qcld_openaiaddon_License_Settings_page
{
	...
	function qcld_callback_quantum_license_key($posted_option){
		...
		if(isset($_POST['submit'])){
			$license_key = isset( $_POST['qcld_openaiaddon_enter_license_or_purchase_key'] ) 	? sanitize_text_field($_POST['qcld_openaiaddon_enter_license_or_purchase_key']) : '';
			$buy_from 	 = isset( $_POST['qcld_openaiaddon__buy_from_where'] ) 					? sanitize_text_field($_POST['qcld_openaiaddon__buy_from_where']) : '';
			$server_type = isset( $_POST['qcld_openaiaddon_site_type'] ) 						? sanitize_text_field($_POST['qcld_openaiaddon_site_type']) : '';
	...
	function qcld_callback_envato_license_key($posted_option){
		if(isset($_POST['submit'])){
			$purchase_code 	= isset( $_POST['qcld_openaiaddon_enter_envato_key'] ) 	? sanitize_text_field($_POST['qcld_openaiaddon_enter_envato_key']) : '';
			$buy_from 		= isset( $_POST['qcld_openaiaddon_buy_from_where'] ) 	? sanitize_text_field($_POST['qcld_openaiaddon_buy_from_where']) : '';
			$server_type 	= isset( $_POST['qcld_openaiaddon_site_type'] ) 		? sanitize_text_field($_POST['qcld_openaiaddon_site_type']) : '';
			$plugin_name 	= openaiaddon_LICENSING_PLUGIN_NAME;
			$current_domain_url =  site_url() ;
			$current_domain = str_replace(
