...
define('QCLD_wpCHATBOT_VERSION', '5.0.7');
...
$gcdirpath = __DIR__.'/../../../../wpbot-dfv2-client'; //Should be 4 folder behind
define('QCLD_wpCHATBOT_GC_DIRNAME', $gcdirpath);
$wpcontentpath = __DIR__.'/../../../../'; //Should be 4 folder behind
...
class qcld_wb_Chatbot
{
    ...
    public function qcld_wb_chatbot_admin_scripts($hook)
    {
        ...
        if (((!empty($_GET["page"])) && ($_GET["page"] == "wpbot")) || ($hook == "widgets.php") || $_GET['page']=='wpbot_help_page' || $_GET['page']=='wpbot_openAi'
            ...
            wp_register_style('qlcd-wp-chatbot-font-awesome', QCLD_wpCHATBOT_PLUGIN_URL . '/css/font-awesome.min.css',  '', QCLD_wpCHATBOT_VERSION, 'screen');
            ...
            //wp_register_style('qlcd-openai-bootstap',  QCLD_wpCHATBOT_PLUGIN_URL . '/openai/css/openai-admin-style.css',  array(), true);
            ...
            wp_register_script('qcld-wp-fontpicker', QCLD_wpCHATBOT_PLUGIN_URL . '/js/fontpicker.js',  array(), true);
            wp_enqueue_script('qcld-wp-fontpicker');
            wp_register_script('qcld-wp-chatbot-cbpFWTabs', QCLD_wpCHATBOT_PLUGIN_URL . '/js/cbpFWTabs.js',  array(), true);
            wp_enqueue_script('qcld-wp-chatbot-cbpFWTabs');
            wp_register_script('qcld-wp-chatbot-modernizr-custom', QCLD_wpCHATBOT_PLUGIN_URL . '/js/modernizr.custom.js',  array(), true);
            wp_enqueue_script('qcld-wp-chatbot-modernizr-custom');
            wp_register_script('qcld-wp-chatbot-bootstrap-js', QCLD_wpCHATBOT_PLUGIN_URL . '/js/bootstrap.js',  array('jquery'), true);
            wp_enqueue_script('qcld-wp-chatbot-bootstrap-js');

            // wp_register_script('qcld-wp-openai-setting-js', QCLD_wpCHATBOT_PLUGIN_URL . '/js/openai_settings.js',  array('jquery'), true);
            ...
            wp_register_style('qcld-wp-chatbot-bootstrap-css', QCLD_wpCHATBOT_PLUGIN_URL . '/css/bootstrap.min.css',  '', QCLD_wpCHATBOT_VERSION, 'screen');
            wp_enqueue_style('qcld-wp-chatbot-bootstrap-css');
            //jquery time picker
            wp_register_script('qcld-wp-chatbot-timepicker-js', QCLD_wpCHATBOT_PLUGIN_URL . '/js/jquery.timepicker.js',  array('jquery'), true);
            wp_enqueue_script('qcld-wp-chatbot-timepicker-js');
            wp_register_style('qcld-wp-chatbot-timepicker-css', QCLD_wpCHATBOT_PLUGIN_URL . '/css/jquery.timepicker.css',  '', QCLD_wpCHATBOT_VERSION, 'screen');
            wp_enqueue_style('qcld-wp-chatbot-timepicker-css');
			
            wp_register_script('qcld-wp-chatbot-admin-js', QCLD_wpCHATBOT_PLUGIN_URL . '/js/qcld-wp-chatbot-admin.js',  array('jquery', 'jquery-ui-core','jquery-ui-sortable','wp-color-picker','qcld-wp-chatbot-timepicker-js'), '10.9.9', true);
    ...
    public function qcld_wb_chatbot_frontend_scripts()
    {
        ...
        wp_register_script('qcld-wp-chatbot-slimscroll-js', QCLD_wpCHATBOT_PLUGIN_URL . '/js/jquery.slimscroll.min.js',  array('jquery'), QCLD_wpCHATBOT_VERSION, true);
        wp_enqueue_script('qcld-wp-chatbot-slimscroll-js');
        wp_register_script('qcld-wp-chatbot-jquery-cookie', QCLD_wpCHATBOT_PLUGIN_URL . '/js/jquery.cookie.js',  array('jquery'), QCLD_wpCHATBOT_VERSION, true);
        wp_enqueue_script('qcld-wp-chatbot-jquery-cookie');
        wp_register_script('qcld-wp-chatbot-magnify-popup', QCLD_wpCHATBOT_PLUGIN_URL . '/js/jquery.magnific-popup.min.js',  array('jquery'), QCLD_wpCHATBOT_VERSION, true);
        wp_enqueue_script('qcld-wp-chatbot-magnify-popup');
        wp_register_script('qcld-wp-chatbot-plugin', QCLD_wpCHATBOT_PLUGIN_URL . '/js/qcld-wp-chatbot-plugin.js',  array('jquery', 'qcld-wp-chatbot-jquery-cookie','qcld-wp-chatbot-magnify-popup'), QCLD_wpCHATBOT_VERSION, true);
        wp_enqueue_script('qcld-wp-chatbot-plugin');

        wp_register_script('qcld-wp-chatbot-front-js', QCLD_wpCHATBOT_PLUGIN_URL . '/js/qcld-wp-chatbot-front.js',  array('jquery', 'qcld-wp-chatbot-jquery-cookie'), QCLD_wpCHATBOT_VERSION, true);
        wp_enqueue_script('qcld-wp-chatbot-front-js');
        wp_localize_script('qcld-wp-chatbot-front-js', 'wp_chatbot_obj', $wp_chatbot_obj);
        //wp_register_script('qcld-wp-chatbot-frontend', QCLD_wpCHATBOT_PLUGIN_URL . '/js/qcld-wp-chatbot-frontend.js',  array('jquery','qcld-wp-chatbot-jquery-cookie'), QCLD_wpCHATBOT_VERSION, true);
        ...
        wp_register_style('qcld-wp-chatbot-magnific-popup', QCLD_wpCHATBOT_PLUGIN_URL . '/css/magnific-popup.css',  '', QCLD_wpCHATBOT_VERSION, 'screen');
        ...
        if (isset($_POST['_wpnonce']) && wp_verify_nonce($_POST['_wpnonce'], 'wp_chatbot')) {
            ...
            if (isset($submit)) {
               ...
               //Viber
                ...
                wp_enqueue_script( 'wp_chatbot_bot-front-js', QCLD_wpCHATBOT_PLUGIN_URL . '/js/sweetalrt.js', array('jquery'), '', true);
                $script = "
                    console.log('sdaas');
    ...
    if (current_user_can( 'manage_options' )) {
        if (isset($_POST['str_nonce']) && wp_verify_nonce($_POST['str_nonce'],'str-nonce') ) {
            ...
            if(isset($_POST['qc_bot_str_query']) && $_POST['qc_bot_str_query']!='' && !class_exists('Qcld_str_pro')){
                ...
                $nonce = isset( $_POST['str_nonce'] ) ? sanitize_text_field($_POST['str_nonce']) : '';
                if ( ! wp_verify_nonce( $nonce, 'str-nonce' ) ) {
                    die( esc_html__( 'Security check failed', 'textdomain' ) ); 
                } 
                $query      = isset( $_POST['qc_bot_str_query'] ) ? wp_unslash(sanitize_text_field($_POST['qc_bot_str_query'])) : '';
                $keyword    = isset( $_POST['qc_bot_str_keyword'] ) ? wp_unslash(sanitize_text_field($_POST['qc_bot_str_keyword'])) : '';
                $intent     = isset( $_POST['qc_bot_str_intent'] ) ? wp_unslash(sanitize_text_field($_POST['qc_bot_str_intent'])) : '';
