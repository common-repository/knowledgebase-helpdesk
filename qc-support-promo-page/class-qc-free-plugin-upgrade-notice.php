...
if( !class_exists('QcKBXPluginUpgradeToProNotice') )
{
    class QcKBXPluginUpgradeToProNotice {
        ...
        function func_qc_external_upgrade_link()
        {
           global $submenu;
            ...
            $link_text = '<span class="qc-up-pro-link"  style="font-weight: bold; padding: 5px; background: #2271B1; border-radius: 4px; color: '.esc_attr($this->link_color).'">'.$this->link_text.'</span>';
            if($current_user->roles[0]!='subscriber')
                $submenu["edit.php?post_type=kbx_knowledgebase"][23] = array( $link_text, 'activate_plugins' , $this->upgrade_link );
            return $submenu;
        }



    } //End of class QcKBXPluginUpgradeToProNotice
...
$instance_woowbot = new QcKBXPluginUpgradeToProNotice();
...
if( is_admin() )
{
    ...
    $instance_woowbot->upgrade_link = "https://www.quantumcloud.com/products/knowledgebase-helpdesk/";
    ...
    $instance_woowbot->plugin_slug = 'knowledgebase-helpdesk'; //Plugin Slug. i.e. Folder Name
    $instance_woowbot->plugin_main_file = 'kbx-main-file.php'; //Primary file of the pluign
    $instance_woowbot->plugin_menu_slug = 'kbx-qc'; //Main Menu Slug
